        ...
        <div className="flex relative flex-col gap-10 bg-white justify-between  shadow-2xs rounded-xl  p-8 w-full border border-gray-200 ">
            <div className="flex gap-10">
                ...
                <div className="relative w-90">
                    <img className="w-90 h-150 rounded object-cover" src={"/examples/videoImage.png"}/>
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex gap-8">
                        ...
                        <div className="flex gap-2">
                            ...
                            <div className="text-sm">5 Minute Watch</div>
                        </div>

                        {/* XP */}
                        <div className="flex gap-2">
                            <SVG_stack className="h-5 fill-gray-400"/>
                            <div className="text-sm">250 XP</div>
                        </div>
                    </div>
                    ...
                    {/* BUTTON */}
                    <div className="bg-primary text-white text-sm rounded-md hover:bg-primary-hover hover:cursor-pointer w-fit pr-6 pl-6 p-3">Complete Lesson</div>
                </div>
            </div>
        </div>
    </div>
